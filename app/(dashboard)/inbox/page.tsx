...
// Phase 3: the inbox page is a thin shell that renders whatever the
// dashboard previously rendered. The richer inbox UI (left rail + single
// conversation view) ships in Phase 5 — DO NOT touch the client UI here.
...
export default async function InboxPage() {
  ...
  try {
    ...
    console.error('[support-inbox] recovery fallback', error)
    return (
